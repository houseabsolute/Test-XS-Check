...
https://metacpan.org/release/Test-XS-Check

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Test::XS::Check
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Test::XS::Check
...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/Test-XS-Check).
...
can submit an issue report [via the web](https://github.com/houseabsolute/Test-XS-Check/issues)
).
